...
import com.wdta.wdtpulltoloadmoreorrefreshlayout.WDTPullToRefreshHeadView

class HeadRefreshView : FrameLayout, WDTPullToRefreshHeadView {
    ...
    init {
        mDefaultRefreshHeadView =
            LayoutInflater.from(context).inflate(R.layout.view_default_refeash_head_view, null)
